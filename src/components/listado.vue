<template>
        <Ly flexbox=1 column=1 grow=1 height=1 data-component="Listado" class="qe" style="padding:0" ref="listado">
			...
			c9.219,0,16.699,7.475,16.699,16.699C406.294,309.756,398.813,317.231,389.594,317.231z"/>	</g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g><g></g></svg>
                        <span style="margin-top:-3px;float:left;padding-left:3px;position:absolute"></span>
...
export default {
    ...
    methods: {
        ...
        clickFunc ( func, event ) {
            ...
            if ( func == "SUM" )
                $slot.find('svg').addClass('hide').eq(0).removeClass('hide')
            if ( func == "AVG" )
                $slot.find('svg').addClass('hide').eq(1).removeClass('hide')
            if ( func == "DISTINCT" )
                $slot.find('svg').addClass('hide').eq(2).removeClass('hide')
